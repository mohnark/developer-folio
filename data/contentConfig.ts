...
export const footerData = {
    ...
    socialLinks: [
      { href: 'https://github.com/mohnark', icon: 'FaGithub' },
      { href: 'https://www.linkedin.com/in/mohnark', icon: 'FaLinkedin' },
      // { href: 'https://x.com/rajaaaqib775', icon: 'FaSquareXTwitter' },
      { href: 'https://instagram.com/kumi.raza', icon: 'FaInstagram' },
      { href: 'mailto:kumail0691@gmail.com', icon: 'FaEnvelope' },
      { href: 'https://fiverr.com/kumail420', icon: 'TbBrandFiverr' },
      { href: 'https://www.upwork.com/freelancers/~01b26f0d1ac0251c07', icon: 'FaSquareUpwork' },
    ],
  };
